        ...
        <section className="px-6 py-20 md:px-10 md:py-24">
          <div className="mx-auto grid max-w-6xl items-center gap-14 md:grid-cols-2">
            <div>
              ...
              <Link
                href="/book"
                className="inline-block rounded-full bg-[#102f35] px-8 py-3 font-bold text-white transition hover:bg-[#411b3f]"
              >
          ...
          <div className="mx-auto max-w-6xl">
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
              ...
              <div className="rounded-3xl border border-gray-100 bg-white p-8 shadow-sm">
                ...
                <Link href="/book?service=Website+Audit" className="font-semibold text-[#102f35] hover:text-[#411b3f]">
                  Request a website audit
                </Link>
              </div>
            </div>
          ...
          <div className="mx-auto max-w-6xl">
            ...
            <div className="grid gap-8 md:grid-cols-3">
              {homeCaseStudies.map((study) => (
                <div key={study.title} className="rounded-3xl border border-gray-200 bg-gray-50 p-8">
                  <h3 className="mb-4 text-2xl font-bold text-[#102f35]">{study.title}</h3>
                  <p className="mb-6 leading-relaxed text-gray-700">{study.description}</p>
                  <Link
                    href={study.industryHref}
                    className="font-semibold text-[#102f35] hover:text-[#411b3f]"
                  >
                    {study.industryLabel} →
                  </Link>
                </div>
          ...
          <div className="mx-auto max-w-6xl">
            ...
            <div className="grid gap-8 md:grid-cols-3">
              {homeTestimonials.map((testimonial, index) => (
                ...
                >
                  <p className="mb-6 italic text-gray-600">&ldquo;{testimonial.quote}&rdquo;</p>
                  <p className="font-bold text-[#102f35]">- {testimonial.author}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="mx-auto max-w-4xl">
            ...
            <div className="space-y-4">
              {homeFaqs.map((faq) => (
                <details
                  key={faq.q}
                  className="group overflow-hidden rounded-2xl border border-gray-100 bg-gray-50 shadow-sm"
                >
                  <summary className="flex cursor-pointer list-none items-center justify-between p-6 font-bold text-[#102f35] hover:bg-gray-100">
                    {faq.q}
