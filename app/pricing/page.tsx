        ...
        <FadeIn>
          <section className="relative py-24 px-6 md:px-12 bg-white">
            ...
            <div className="grid md:grid-cols-3 gap-10 max-w-7xl mx-auto">
              ...
              {/* === GROWTH: MOST POPULAR === */}
              <div className="bg-white shadow-2xl rounded-2xl p-8 border-t-4 border-yellow-400 hover:-translate-y-2 transition transform scale-105 z-10 relative">
                {/* Most Popular Badge */}
                <div className="absolute top-0 right-8 transform -translate-y-1/2 bg-yellow-400 text-[#102f35] px-4 py-1 rounded-full text-xs font-bold uppercase">
                  Most Popular
                </div>
