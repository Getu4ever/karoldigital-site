...
export const metadata = generateSEOMetadata({
  ...
  description:
    "About Karol Digital — a London web design studio building high-performance websites for UK service businesses that need trust, clarity, and more enquiries.",
